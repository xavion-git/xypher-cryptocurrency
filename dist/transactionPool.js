...
const getTransactionPoolSorted = (unspentTxOuts) => {
    return lodash_1.default.orderBy(transactionPool, [(tx) => (0, transaction_1.getTransactionFee)(tx, unspentTxOuts)], ['desc']);
};
